...
let borodinPolovetsian = {
  ...
  videos: [
    ...
    [
      'Herbert von Karajan, Berliner Philharmoniker (With Score}',
      'wcdp-YT79Ek',
    ],
...
let brahmsAcademic = {
  ...
  videos: [
    [
      'Bernard Haitink, Royal Concertgebouw Orchestra (With Score}',
      '5AkQrnLPvC4',
    ],
    ...
    // Bands
    [
      'Mark H. Hindsley, The University of Illinois Concert Band',
      'fiW2N96aPoE',
    ],
  ],
};
...
let franckD = {
  ...
  videos: [
    ...
    [
      'Marc Soustrot, University of Gothenburg Symphony Orchestra',
      '9srAs4ss2kU',
    ],
...
let haydnCreation = {
  ...
  videos: [
    [
      'Adam Fischer, Austro-Hungarian Haydn Philharmonic Orchestra & Wiener Kammerchor',
      'xIpSNMQZH9M',
    ],
    ['Christopher Hogwood, Academy of Ancient Music', 'bH5KM700AlQ'],
    [
      'Leonard Berstein, Bavarian Radio Chorus and Symphony Orchestra',
      '4OGk679VGQo',
    ],
    [
      'Leonardo García Alarcón, The Netherlands Radio Philharmonic Orchestra',
      '6ObRBb3aBG4',
    ],
...
let mahler3 = {
  ...
  videos: [
    ...
    // Masterclasses
    [
      'Dietmar Küblböck, Vienna Philharmonic Trombone Master Class',
      'rTpmWlGjjVU',
    ],
...
let mussorgskyPictures = {
  ...
  videos: [
    ...
    [
      'Symphonieorchester des Bayerischen Rundfunks (With Score}',
      'QLa_MIWZJow',
    ],
  ],
};
...
let rimskyKorsakovGolden = {
  ...
  videos: [
    [
      'Dmitri Kitaenko, Academic Symphony Orchestra of Moscow State Philharmonic',
      'PZt9sG5lxd0',
    ],
...
let rossiniWilliamTell = {
  ...
  videos: [
    ...
    [
      'Joni Swenson, Santa Monica High School Symphony Orchestra',
      'YIMJ1yfR19Y',
    ],
    ...
    [
      'Colonel Michael J. Colburn, "The President\'s Own" United States Marine Band',
      'mZF4xHhPtRc',
    ],
    // Masterclasses
...
let schumann1 = {
  ...
  videos: [
    ...
    [
      'Zubin Mehta, The Buchmann-Mehta School of Music Symphony Orchestra',
      'abrie8X9seU',
    ],
  ],
};
...
let schumann3 = {
  ...
  videos: [
    ...
    [
      'Michael Boder, Berliner Philharmoniker (Trombone Tutorial}',
      'ZkDkfWJy2S0',
    ],
...
let stravinskyFirebird = {
  ...
  videos: [
    [
      "정명훈 (Chung Myung-Whun}, Orchestre de l'Opera Bastille (With Score}",
      '6wbkKWrUD-A',
    ],
...
let tchaikovskyFrancesca = {
  ...
  videos: [
    ...
    [
      'Semyon Bychkov, Royal Academy of Music Symphony Orchestra',
      'FmKymqHg4ak',
    ],
    [
      'Veronika Dudarova, Symphony Orchestra of Russia (With Score}',
      '2amnA_rVrRE',
    ],
...
let verdiForza = {
  ...
  videos: [
    ...
    [
      'Giuseppe Sinopoli, Vienna Philharmonic Orchestra (With Score}',
      '8lBI2wu4OIc',
    ],
...
let verdiNabucco = {
  ...
  videos: [
    ...
    [
      'Zygmunt Nitkiewicz, Orchestra Of The Józef Marcin Żebrowski Music School',
      'OseGETWEnCo',
    ],
  ],
};
...
let wagnerFlying = {
  ...
  videos: [
    ...
    [
      'Joseph Keilberth, Bayreuth Festival Orchestra (With Score}',
      'HI3CS0xfico',
    ],
...
let wagnerValyrie = {
  ...
  videos: [
    ...
    [
      'Tim Buzbee, Jessica Buzbee, James Decker, and James Meador',
      '80o8Q6G_HDQ',
    ],
  ],
};
...
let smetana = {
  ...
  dates: '1824-1884',
  bio:
    'Smetana was a child prodigy who had his first composition performed at age six. His music became closely tied to sentiments and movements of independant statehood. He became completely deaf for the last ten years of his life.',
