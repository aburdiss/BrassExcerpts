const YouTubeModel = {
  bachBrandenburg1: {
    ...
    score: [
      ['Claudio Abbado', '4kI1Ab6_Xfk'],
      ['Trevor Pinnock, The English Concert', '7TlG6LMQR9M'],
    ],
  },
  ...
  bachBrandenburg2: {
    ...
    score: [['The English Concert', 'haRanlw9eSg']],
    trumpet: [['Philip Smith', 'bEurgaV3Q9A']],
  },
  ...
  bachCantata51: {
    ...
    score: [
      ['Somogyváry Ákos, Caritas Collectio Chamber Orchestra', 'qrR3VmrQxrc'],
    ],
  },
  ...
  bachChristmasOratorio: {
    full: [
      ...
      [
        'Nikolaus Harnoncourt, Soloists of the Tolzer Knabenchor',
        '98UjjwzJBFE',
      ],
      [
        'Nikolaus Harnoncourt, Soloists of the Tolzer Knabenchor',
  ...
  bachCelloSuite: {
    ...
    trombone: [['Inbal Segev Masterclass', 'gfPqOmp9p-0']],
  },
  ...
  bachMagnificant: {
    ...
    score: [['Michel Corboz', 'q8Oeq12zjZk']],
    trumpet: [
  ...
  bachMassB: {
    ...
    score: [['Frans Brüggen, Orchestra of the 18th Century', 'EH6wdRVqoXQ']],
  },
  ...
  beethovenLeonore2: {
    ...
    score: [['Claudio Abbado, Vienna Philharmonic Orchestra', 'UxB_28XuaO4']],
    trumpet: [['Philip Smith', 'NmMCBiu1sno']],
  },
  ...
  beethovenLeonore3: {
    full: [
      ...
      [
        'Leonard Bernstein, Bavarian Broadcast Symphony Orchestra',
        'dRhwyzJABvI',
      ],
      [
    ...
    score: [['Anton Nanut, Radio-Symphonieorchester Wien', '_0pz7zkKcA0']],
    trumpet: [
  ...
  beethoven2: {
    ...
    score: [['Herbert von Karajan, Berlin Philharmonic', 'pZyeEeXhYs4']],
  },
  ...
  beethoven6: {
    ...
    score: [['Herbert von Karajan, Berlin Philharmonic', 'p4CCU2-AFZE']],
  },
  ...
  beethoven8: {
    ...
    score: [['Herbert von Karajan, Berlin Philharmonic', 'fa6DRoxpOwg']],
  },
  ...
  beethoven9: {
    ...
    score: [['Herbert von Karjan, Berlin Philharmonic', 'ixpfgm_xxSE']],
    trombone: [['Southeast Trombone Symposium', 'Sd6es2t0eU4']],
  },
  ...
  berliozRomanCarnival: {
    ...
    trombone: [['Ralph Sauer', 'Ym0Ga_oZJAk']],
  },
  ...
  bizetCarmen: {
    ...
    trumpet: [['Philip Smith', 'w5yHjjepMV4']],
  },
  ...
  bizetLArlesienne: {
    ...
    score: [
      [
        'Kiyotaka Keraoka, Hamamatsu International Wind Instrument Academy Festival Orchestra',
        'QWEpO37VVNY',
      ],
    ],
  },
  ...
  brahmsAcademic: {
    ...
    score: [['Bernard Haitink, Royal Concertgebouw Orchestra', '5AkQrnLPvC4']],
  },

  brahmsPiano1: {
    full: [['Valery Gergiev', 'Yxn8E6v8akQ']],
  ...
  brahmsPiano2: {
    ...
    score: [['Leonard Bernstein, Vienna Philharmonic', 'tWoFaPwbzqE']],
  },
  ...
  brahms1: {
    ...
    score: [['Karl Böhm, Berliner Philharmoniker', 'POW-u-RGspY']],
    trombone: [['Ralph Sauer', '6p0_47CAmOg']],
  },
  ...
  brahms2: {
    full: [
      ...
      [
        'Philippe Herreweghe, Frankfurt Radio Symphony Orchestra',
        'vMPP8DkVhk8',
      ],
    ],
    score: [['Carlos Kleiber, Wiener Philharmoniker', 'HCkSpCh4Wcw']],
    trombone: [
  ...
  brahms3: {
    ...
    score: [['Sir John Barbirolli, Wiener Philharmoniker', 'Lst1Aex2vcQ']],
  },
  ...
  brahmsVariations: {
    ...
    score: [['Ricardo Muti, Philadelphia Orchestra', 'oMJVCdhJZPk']],
  },
  ...
  debussyNocturnes: {
    ...
    trumpet: [['Philip Smith', 'qwBbTvAeOss']],
  },
  ...
  debussyLaMer: {
    ...
    score: [['Vladimir Ashkenazy, Cleveland Orchestra', 'KUFpcPEcwTo']],
    trumpet: [['Philip Smith', 'N0__fUmoMT8']],
  },
  ...
  dvorak8: {
    ...
    score: [['Václav Neumann, Czech Philharmonic', '6O6Nme3fw5k']],
  },
  ...
  dvorak9: {
    ...
    score: [['Ferenc Fricsay, Berliner Philharmoniker', 'oLWpgWuUaU4']],
  },
  ...
  haydnCreation: {
    full: [
      ...
      [
        'Richard Sparks, UNT Symphony Orchestra and Grand Chorus',
        'eqwHKoCqCHU',
      ],
    ],
    trombone: [['Denson Paul Pollard', '3gaT_BhYSIY']],
  },
  ...
  holstFirstSuite: {
    ...
    score: [
      ['Frederick Fennell, The Cleveland Symphonic Winds', 'RrRwoD1Yx8A'],
    ],
  },
  ...
  holstPlanets: {
    ...
    score: [
      ['André Previn,  London Symphony Orchestra', 'YRDF2YJojAM'],
  ...
  lisztLesPreludes: {
    full: [
      ...
      [
        'Wojciech Pławner, Symphony Orchestra of the Karol Szymanowski State Music School',
        'psCI_CQ9jaU',
      ],
    ],
    score: [
  ...
  mahler9: {
    ...
    score: [
      ['Leonard Bernstein, Berlin Philharmonic Orchestra', 'ah3mcaRpc9Q'],
    ],
  },
  ...
  rimskyKorsakovRussianEaster: {
    full: [
      [
        'Andrés Cárdenes, Carnegie Mellon University Philharmonic',
        'oH8dS9gKPzw',
      ],
  ...
  rimskyKorsakovScheherazade: {
    full: [
      ...
      [
        'Yuri Temirkanov, Saint-Petersburg Philharmonic Orchestra',
        'vdnUBQT5Bqw',
      ],
    ],
    trombone: [['Ralph Sauer', 'YkY8cig-26s']],
  ...
  rossiniLaGazza: {
    ...
    trombone: [['Ralph Sauer', 'E_SgibgP2LI']],
  },
  ...
  schubert8: {
    ...
    score: [
      [
        'Wolfgang Sawallisch, Staatskapelle Dresden (With Score)',
        '0mnrHf7p0jM',
      ],
    ],
  },
  ...
  schubert9: {
    ...
    trombone: [['Ralph Sauer', 'neudoAIzgaw']],
  },
  ...
  schumann4: {
    ...
    score: [['Wolfgang Sawallisch, Staatskapelle Dresden', 'BfLxzNakUZw']],
    trombone: [
  ...
  sousaStarsAndStripes: {
    full: [['John Williams, Boston Pops Orchestra', 'QAnky-QJwII']],
    band: [
  ...
  straussZarathustra: {
    ...
    score: [
      ['Herbert von Karajan, Berlin Philharmonic Orchestra', 'c8r_pZoaZf0'],
    ],
    trombone: [
      ['Joseph Alessi', 'Mm8lPg8O0vw'],
  ...
  straussDeathAndTransfiguration: {
    ...
    score: [
      ['Arturo Toscanini, NBC Orchestra', 'L3bD7g3mp_Y'],
      ['David Zinman, Tonhalle Orchestra Zürich', '6hfQpaePuxo'],
    ],
  },
  ...
  straussDonQuixote: {
    ...
    score: [
      [
        "George Pehlivanian, Orchestra dell'Accademia Nazionale di Santa Cecilia",
        '5PvCGu2Ue0U',
      ],
    ],
    trombone: [['Michael Mulcahy', 'oHsbvs-xn6o']],
  },
  ...
  straussSinfoniaDomestica: {
    ...
    score: [['George Szell, Cleveland Orchestra', 'ETQWcUkLGRE']],
  },
  ...
  straussEulenspiegel: {
    ...
    score: [
      ['Leonard Bernstein, New York Philharmonic Orchestra', '1zbCfP9wGt4'],
      [
        'Lorin Maazel, Symphonieorchester des Bayerischen Rundfunk',
        'QV5r9KG1eyc',
      ],
    ],
  ...
  stravinskyFirebird: {
    ...
    score: [
      [
        "정명훈 (Chung Myung-Whun}, Orchestre de l'Opera Bastille",
        '6wbkKWrUD-A',
      ],
    ],
  ...
  tchaikovsky4: {
    ...
    score: [
      [
        'Gennady Rozhdestvensky, USSR State TV and Radio Symphony Orchestra',
        '_Xldfaf4NGw',
      ],
    ],
  ...
  tchaikovsky6: {
    full: [
      [
        '정명훈 (Chung Myung-Whun), Seoul Philharmonic Orchestra',
        'IH-zp9LjiEs',
      ],
  ...
  verdiForza: {
    ...
    score: [
      ['Giuseppe Sinopoli, Vienna Philharmonic Orchestra', '8lBI2wu4OIc'],
    ],
    trombone: [['Ralph Sauer', 'A8Rs_enuapU']],
  },
  ...
  wagnerRheingold: {
    ...
    score: [
      ['Georg Solti, Vienna Philharmonic Orchestra', 'loTqK2Fyrrw'],
      ['Georg Solti, Vienna Philharmonic Orchestra', 'VsR11uFzBJg'],
    ],
  ...
  wagnerFlying: {
    ...
    score: [['Joseph Keilberth, Bayreuth Festival Orchestra', 'HI3CS0xfico']],
  },
  ...
  wagnerValkyrie: {
    ...
    score: [['Georg Solti, Vienna Philharmonic Orchestra', 'Qx55EmiFadg']],
    trombone: [
      ...
      [
        'Thomas Leyendecker, Carnegie Hall Trombone Master Class',
        'NRWlHRvaDcQ',
      ],
      [
  ...
  wagnerSigfried: {
    ...
    score: [['Georg Solti, Vienna Philharmonic Orchestra', 'j5pATBWOsLc']],
  },
  ...
  wagnerTannhauser: {
    ...
    score: [
      ...
      ['Zubin Mehta, New York Philharmonic Orchestra', '3_Eq9H4bSdQ'],
    ],
    trombone: [['Ralph Sauer', 'b83be3aogOM']],
  },
