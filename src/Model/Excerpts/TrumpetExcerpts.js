...
let bachCantata = {
  ...
  videos: [
    ...
    [
      'Somogyváry Ákos, Caritas Collectio Chamber Orchestra (With Score}',
      'qrR3VmrQxrc',
    ],
  ],
};
...
let bachMassB = {
  ...
  videos: [
    [
      'Frans Brüggen, Orchestra of the 18th Century (With Score}',
      'EH6wdRVqoXQ',
    ],
...
let beethovenLeonore2 = {
  ...
  videos: [
    ...
    [
      'Claudio Abbado, Vienna Philharmonic Orchestra (With Score}',
      'UxB_28XuaO4',
    ],
...
let beethovenLeonore3 = {
  ...
  videos: [
    ...
    [
      'Nicolás Pasquet, Orchestra of the University of Music FRANZ LISZT Weimar',
      'OOIlQkANUxQ',
    ],
...
let bizetCarmen = {
  ...
  videos: [
    ...
    [
      "Jane Ezbicki, New England Conservatory's Youth Repertory Orchestra",
      'tSpzenCTucA',
    ],
    [
      'Lukasz Sidoruk, Symphony Orchestra of The Karol Szymanowski Music School',
      'opMCCil4Pjk',
    ],
...
let debussyLaMer = {
  ...
  excerpts: [
    {
      ...
      pictures: [['F Trumpet 1', '1081']],
    },
    {
      id: 40,
      description: 'Excerpt 2',
      measures: 'Mov. 3, 5 mm. after [52] - 7 mm. after [52]}',
      pictures: [['C Cornet 1', '1082']],
    },
    {
      id: 41,
      description: 'Excerpt 3',
      ...
      pictures: [
        ['F Trumpet 1 and 2', '1083'],
        ['F Trumpet 3', '1084'],
        ['C Cornet 1 and 2', '1085'],
      ],
    },
  ],
  mutes: 'Straight',
  videos: [
    [
      '정명훈 (Chung Myung-Whun}, Orchestre Philharmonique de Radio France',
      'ogYtW1Yb5s4',
    ],
  ...
  excerpts: [
    {
      ...
      pictures: [['B♭ Trumpet 1 and 2', '1086']],
    },
  ],
  mutes: 'No',
  videos: [
...
let mahler2 = {
  ...
  excerpts: [
    ...
    },
    {
      ...
      pictures: [
        ['Offstage F Trumpet 1', '1111'],
        ['Offstage C Trumpet 2', '1112'],
      ],
    },
    {
      id: 56,
      ...
      pictures: [
        ['Offstage F Trumpet 1', '1113'],
        ['Offstage F Trumpet 2', '1114'],
        ['Offstage F Trumpet 3', '1115'],
        ['Offstage F Trumpet 4', '1116'],
      ],
    },
  ],
  mutes: 'Straight',
...
let mahler5 = {
  ...
  excerpts: [
    ...
    },
    {
      ...
      pictures: [['F Trumpet 1', '1137']],
    },
    {
      id: 64,
      description: 'Excerpt 5',
      measures: 'Mov. III, [13] - 8 mm. after [13] ',
      pictures: [['B♭ Trumpet 1', '1138']],
    },
  ],
  mutes: 'Straight',
  videos: [
  ...
  excerpts: [
    {
      ...
      pictures: [['B♭ Trumpet', '1231']],
    },
    {
      id: 101,
      description: 'Excerpt 2',
      measures: 'No. 7, [6] - End',
      pictures: [['B♭ Trumpet', '1232']],
    },
    {
      id: 102,
      description: 'Excerpt 3',
      measures: 'No. 9, [104] - 4 mm. after [106]',
      pictures: [['B♭ Trumpet', '1233']],
    },
    {
      id: 103,
      description: 'Excerpt 4',
      measures: 'No. 9, 4 mm. before [111] - [115]',
      pictures: [['B♭ Trumpet', '1234']],
    },
  ],
  mutes: 'Straight',
  videos: [
  ...
  excerpts: [
    {
      ...
      pictures: [['F Trumpet 1', '1235']],
    },
    {
      id: 105,
      description: 'Excerpt 2',
      measures: '[89] - [90]',
      pictures: [['C Trumpet 3', '1236']],
    },
  ],
  mutes: 'Straight',
  videos: [
  ...
  excerpts: [
    {
      ...
      pictures: [['B♭ Cornet 1', '1249']],
    },
    {
      id: 113,
      description: 'Excerpt 2',
      measures: 'Waltz, 4 mm. after [71] - 1 mm. before [72]',
      pictures: [['B♭ Cornet 1', '1250']],
    },
    {
      id: 114,
      description: 'Excerpt 3',
      measures: 'Waltz, [75] - [76] ',
      pictures: [['B♭ Cornet 1', '1251']],
    },
    {
      id: 115,
      description: 'Excerpt 4',
  ...
  excerpts: [
    {
      ...
      pictures: [['D Piccolo Trumpet 1', '1254']],
    },
  ],
  mutes: 'Straight',
  videos: [
  ...
  excerpts: [
    {
      ...
      description: 'Excerpt 1',
      measures: '[22] - [23]',
      pictures: [['C Trumpet 1 and 2', '1255']],
    },
    {
      id: 118,
      description: 'Excerpt 2',
      measures: '[55] - [57]',
      pictures: [['C Trumpet 1 and 2', '1256']],
    },
    {
      id: 119,
      description: 'Excerpt 3',
      measures: '[68] - [71]',
      pictures: [['C Trumpet 1 and 2', '1257']],
    },
    {
      id: 120,
      description: 'Excerpt 4',
      measures: '[76] - [77]',
      pictures: [['C Trumpet 1 and 2', '1258']],
    },
    {
      id: 121,
      description: 'Excerpt 5',
      measures: '[96] - End',
      pictures: [['C Trumpet 1 and 2', '1259']],
    },
  ],
  mutes: 'Straight',
  videos: [
